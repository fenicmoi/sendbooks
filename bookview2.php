...
include "connect.php" ;
$sql3 = "select * from $tableanswer2 where bookid='$id' and name='$school'" ;
...
<body  leftmargin="0">
  ...
  <CENTER>
    <table border="5" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="750" bordercolorlight="#CACAFF" bordercolordark="#6600CC" bgcolor="#D9ECFF">
      <tr>
        <td width="100%">
        <p align="center"><FONT style="font-size: 19pt" COLOR="#660099">
        หนังสือราชการจาก<? echo _NAME ;?></font></td>
      </tr>
    </table>
    </CENTER>
<br> 
...
<table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#008080" width="800" height="98">
  <tr>
    ...
    &nbsp;&nbsp;หนังสือลำดับที่ : <?=$bookid?> &nbsp;&nbsp;<FONT COLOR="#000000"> จากกลุ่ม : <?=$from?></FONT> &nbsp;&nbsp; 
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    <td width="11%"></td>
    <td width="89%"><?If ($bookfile <>"") {?> <form action="bookviews2.php" method="Post">
					<input type="hidden" name="name"value="<?=$school?>">
						...
						<INPUT TYPE="hidden" name="bookfile" value="<?=$bookfile?>">
						 ...
						 </form><?} elseif ($reply<>"ON") {?> <form action="bookviews2.php" method="Post">
					<input type="hidden" name="name"value="<?=$school?>">
						<input type="hidden" name="answer" value="รับทราบ">
						<input type="hidden" name="id" value="<?=$id?>">
						<INPUT TYPE="hidden" name="bookfile" value="<?=$bookfile?>">
  ...
  <tr>
    ...
    <div align="center">
      ...
      <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#6600CC" width="451" height="149">
        <form method="POST" action="bookviews2.php">
       <tr>
...
?>
  <table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" bordercolor="#808080" width="600">
    <tr>
      ...
      <font color="#808000" style="font-size: 3pt">คำตอบที่  <?=$order?> จากหน่วยงาน<?=$name?>
      </font></b></td>
    </tr>
    <tr>
      <td width="100%"><font color="#000000" style="font-size: 3pt"><?=$answer?></font>&nbsp;</td>
    </tr>
    <tr>
      <td width="100%"><b><font color="#008080" style="font-size: 3pt">เมื่อ <?=$ansthaiday?> เวลา <?=$ans_t?> น.   IP : <?=$ip?> <? if ($score <> 0 ) { echo "ได้ $score คะแนน" ;  } else { echo "หนังสือฉบับนี้ไม่คิดคะแนน" ; } ?>
      </font></b></td>
    </tr>
  </table>
  <BR>
