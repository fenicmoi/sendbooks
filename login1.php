...
<html lang="en">
<head>
	<title>สำนักงานจังหวัดพัทลุง</title>
		...
		<div class="main-area center-text" style="background-image:url(images/countdown-7-1600x900.jpg);" >
			...
			<div class="display-table">
				<div class="display-table-cell">
					...
					<h1 class="title"><b>ขออภัย</b></h1>
					<p class="desc font-white">เนื่องจากระบบขัดข้องด้านเทคนิค  จึงขอหยุดบริการชั่วคราว  เราจะเร่งดำเนินการให้เสร็จโดยเร็วที่สุด..</p>
					
					<a class="notify-btn" href="#"><b>  ติดต่อ Webmaster  Tel/ID LINE 0815399135</b></a>
