...
<body>
<h2 align="center">ส่งหนังสือใหม่ไปยังโรงเรียนเอกชน</h2>
<DIV align="center">
  <CENTER>
  <TABLE border="1" cellpadding="3" cellspacing="1" style="border-collapse: collapse" bordercolor="#C0C0C0" width="780">
    <FORM method="POST" name="form2" action="newbooks2.php" enctype="multipart/form-data">
  <TR>
      ...
      <TR>
        ...
        <TD width="76%">
        <FONT color="#9933FF">
        <INPUT type="radio" value="โรงเรียนทุกโรง" name="sendto"><SPAN lang="en-us">
        </SPAN>โรงเรียนทุกโรง</FONT></TD>
      </TR>
      <TR>
        <TD width="76%"><FONT color="#9933FF">
        <INPUT type="radio" value="โรงเรียน" name="sendto" onclick="doCheck(this);"> โรงเรียน</FONT><SPAN lang="en-us"><FONT color="#9933FF">
      ...
      <TR>
        ...
        (คลิกเลือกกรณีที่ต้องการให้มีฟอร์มเพื่อการตอบกลับจากโรงเรียน)</FONT></SPAN> </TD>
      </TR>
      <TR>
