  ...
  <TR>
    <TD width="100%" height="29" colspan="2"> 
      ...
      <font size="4" style="font-size: 19pt" color="#CC0099"> 
        ระบบงานสารบรรณโรงเรียนเอกชน <? echo _NAME ;?>
...
&nbsp;<input type="button" value="โหลดหน้านี้ใหม่" onClick="window.location='deletebook2.php'" ></TD>
  </TR>
</TABLE>
...
<tr  bgcolor="<?=$color?>">
    ...
    <TD width="28%" height="20">&nbsp;<A HREF="bookviewsave2.php?id=<?=$id?>"  title='คลิกเพื่อเปิดอ่านหนังสือ' style="text-decoration: none" target="_blank"><?=$subject?></A>&nbsp;<? if ($bookfile<>"") {echo"<IMG SRC=image/file.gif WIDTH=13 HEIGHT=10 BORDER=0 ALT='มีไฟล์แนบ'>" ; }?></TD>
    ...
    <TD width="3%" height="20"><CENTER><FONT SIZE="" COLOR="#009900"><A HREF="deletebooks_result2.php?id=<?=$id?>" title="คลิกเพื่อลบหนังสือฉบับนี้" onclick="return confirm ('ต้องการลบหนังสือลำดับที่ <?=$bookid?> ออกจากระบบ ?')"><img src="image/delete.png" border=0></A></FONT></CENTER></TD>
  </TR>
  <?
			$list++;
}
